...
Minimalism is a lifestyle for people whose machines aren't load-bearing. This repo is the opposite - every alias, every plugin, every Claude Code hook, every shell function accreted while building things at speed.
